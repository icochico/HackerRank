...
class Solution
{
  ...
  /**
  * To modify the original list and remove duplicates, we can iterate with two pointers. Current: which iterates through the LinkedList, and runner which checks all subsequent nodes for duplicates.
  * The code below runs in O(1) space but O(N^2) time.
  */
